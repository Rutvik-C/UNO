...
def bot_action(ob):
   ...
   # ob.played_check = 0
    ob.check = 0
    if (ob.current[0] == '+2' or ob.current[0]=='+4') and ob.special_check == 0:#DO NOT CHANGE BRACKETS
